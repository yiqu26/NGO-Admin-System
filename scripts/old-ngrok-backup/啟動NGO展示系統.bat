...
REM ================================================================
REM 第 4 步：啟動 ngrok tunnels
REM ================================================================
cls
echo.
echo ════════════════════════════════════════════════════════════════
echo  [4/5] 啟動 ngrok tunnels...
echo ════════════════════════════════════════════════════════════════
echo.

start "【NGO】ngrok 後端 (5264)" cmd /k "echo ngrok 後端 tunnel 正在運行... && echo 管理介面: http://localhost:4040 && echo. && ngrok http 5264 --log=stdout"
timeout /t 3 /nobreak >nul
start "【NGO】ngrok 前端 (5173)" cmd /k "echo ngrok 前端 tunnel 正在運行... && echo. && ngrok http 5173 --log=stdout"
